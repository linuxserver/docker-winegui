pipeline {
  ...
  environment {
    ...
    EXT_USER = 'winegui'
    EXT_REPO = 'WineGUI'
    BUILD_VERSION_ARG = 'WINEGUI_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-winegui'
    CONTAINER_NAME = 'winegui'
    DOCKERHUB_IMAGE = 'linuxserver/winegui'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/winegui'
    PR_DOCKERHUB_IMAGE = 'lspipepr/winegui'
    DIST_IMAGE = 'debian'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-winegui/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-winegui\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-winegui\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Winegui\" \
          --label \"org.opencontainers.image.description=[WineGUI](https://gitlab.melroy.org/melroy/winegui) is a user-interface friendly Wine manager that provides a graphical frontend for creating and managing Wine bottles.\" \
